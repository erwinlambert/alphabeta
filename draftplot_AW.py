...
dax.streamplot(t,h,dTdx0,dHdx0,color=lw,cmap=cmap,density=.4,arrowsize=6.)
...
lw = n2+n3*mag/mag.max()
dax.streamplot(t,h,dTdx1,dHdx1,color=lw,cmap=cmap,density=.4,arrowsize=6.)
...
lw = n2+n3*mag/mag.max()
dax.streamplot(t,h,dTdx2,dHdx2,color=lw,cmap=cmap,density=.8,arrowsize=6.)
#dax.plot(T0+0.*h,h,color=pur,linewidth=n5)
...
lw = n2+n3*mag/mag.max()
ax.streamplot(t,h,dTdx,dHdx,color=lw,cmap=cmap,density=.8,arrowsize=10.)

#Plot integration
ax.plot(T1,Hth,color=red,linewidth=4.,zorder=9)
ax.scatter(T1[0],Hth[0],150,color=red,label='Inflow',zorder=9,clip_on=False)
ax.scatter(T1[-1],Hth[-1],150,marker='s',color=red,label='Outflow',zorder=9,clip_on=False)
...
mag = (dHdx**2+dTdx**2)**n1
lw = n2+n3*mag/mag.max()
dax.streamplot(t,h,dTdx,dHdx,color=lw,cmap=cmap,density=.8,arrowsize=10.)

#Plot integration
dax.plot(T1,Hth,color=red,linewidth=4.,zorder=9)
dax.scatter(T1[0],Hth[0],150,color=red,label='Inflow',zorder=9,clip_on=False)
dax.scatter(T1[-1],Hth[-1],150,marker='s',color=red,label='Outflow',zorder=9,clip_on=False)
