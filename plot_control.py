...
#ax[0].fill_between(x,0.*x,Psi0,facecolor=pur)
#ax[0].fill_between(x,Psi0,Psi1+Psi0,facecolor=red)
#ax[0].fill_between(x,Psi1+Psi0,Psi1+Psi0+Psi2,facecolor=blu)

ax[0].plot(x,Psi0,color=pur,label='0')
ax[0].plot(x,Psi1,color=red,label='1')
ax[0].plot(x,Psi2,color=blu,label='2')
ax[0].legend(loc='upper right')

ax[1].plot(x,T0+0.*x,color=pur)
ax[1].plot(x,T1,color=red)
ax[1].plot(x,T2,color=blu)

ax[2].plot(x,Sin+0.*x,color=pur)
ax[2].plot(x,Sin+0.*x,'--',color=red)
ax[2].plot(x,S2,color=blu)

ax[0].set_ylim([0.,Psi1[0]+1.])
ax[1].set_ylim([T0-1.,T1[0]+1.])
...
fname = '../figures/plot_control.png'
